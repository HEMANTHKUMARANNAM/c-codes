...
void searchfun(){
	...
	if(flag==0){
		...
		gotoxy(39,6);
		printf("Enter a to search another contact:");
		if(getch()=='a'){
			system("cls");
			searchfun();
		}
...
void listfun(){
	...
	system("cls");
	gotoxy(31,2);
	printf("\xB3\xDB\xDB\xDB\xDB\xDB\xDB\xDB\xDB LIST SECTION \xDB\xDB\xDB\xDB\xDB\xDB\xDB\xDB\xB3");
	printf("\n");
...
void exitfun(){
	...
	gotoxy(31,6);
	printf("\xDB G SIVA KRISHNA SATHVIK.");
	gotoxy(31,8);
	printf("\xDB SK MUDASSIR AHMED.");
	gotoxy(31,10);
	printf("\xDB K NADEEM KHAN.");
	gotoxy(31,12);
	printf("\xDB M BHANU PRAKASH.");
	gotoxy(31,14);
	printf("\xDB S VENKAT SAI MANOJ NAIDU.");
}
void password(void){
	char passwords[20]={"S"};
	gotoxy(22,2);
...
void menu(){
	system("cls");
	gotoxy(30,1);
	printf("\xB3\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2 PASSWORD PROTECTED PHONE-BOOK \xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB3");
	gotoxy(31,4);
